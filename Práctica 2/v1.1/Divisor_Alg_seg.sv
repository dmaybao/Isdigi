...
localparam etapas=2*tamanyo+1;//eliminamos el contador 
...
DenNoCero: assert property (@(posedge CLK) Start ->Den !=0) else $info("El Denominador da 0");
