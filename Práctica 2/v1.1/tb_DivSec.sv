...
// Module Name:     FIFO
// Project Name:    FIFO
// Description:     Módulo de verificación para Dvivisor_Algoritmico
//
...
module tb_DivSec;
    ...
    initial begin
        ...
        // Reset del sistema
        #10 RSTa = 1;  // Activar reset asíncrono
        #10 RSTa = 0;  // Quitar reset
        #10 RSTa = 1;  // Vuelve al estado normal

        // Caso 1: División positiva 100 / 3
        #10 Num = 100; Den = 3; Start = 1;
        ...
        $display("División 100 / 3: Coc = %d, Res = %d", Coc, Res);
