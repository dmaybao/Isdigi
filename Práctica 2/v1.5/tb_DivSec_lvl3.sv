...
// Module Name:     tb_DivSec_lvl3
// Project Name:    Divisor_Algoritmico
// Description:     Módulo de verificación para Divisor_Algoritmico de nivel 3
//                  con el uso de una interface, clocking block y scoreboard.
//
...
module tb_DivSec_lvl3;

// Parámetros
    parameter tamanyo = 32;

// Interface
interface DivSecInterface(input logic CLK);
    parameter tamanyo = 32;
    ...
    // Clocking block (para sincronización de lectura)
...
logic CLK;
DivSecInterface divsec_if (CLK); // Instanciación de la interface
...
initial begin
    ...
    repeat (50) begin
        ...
        // Asignar valores aleatorios directamente a las señales de la interface
        divsec_if.Num = bus_inst.Num_value;
        divsec_if.Den = bus_inst.Den_value;

        // Generar pulso de inicio
        divsec_if.Start = 1;
        #10 divsec_if.Start = 0;

        // Esperar a que Done se active
        @(posedge divsec_if.Done);
